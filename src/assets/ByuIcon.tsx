...
export const BuyIcon = (props: IIcon) => {
  return (
      <svg {...props} viewBox="0 0 24 24"  xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M2.74991 3.25L4.82991 3.61L5.79291 15.083C5.87091 16.018 6.65191 16.736 7.58991 16.736H18.5019C19.3979 16.736 20.1579 16.078 20.2869 15.19L21.2359 8.632C21.3529 7.823 20.7259 7.099 19.9089 7.099H5.16391" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
